    ...
    for update in updates:
        ...
        if "TP :" in text and "SL :" in text and "Prix" in text:
            ...
            if start != -1 and end != -1:
                ...
                print('buy or sell (BorS,L_S,close):',BorS,L_S,close)
                #print(type(BorS))
                #print(type(close))
            ...
            if start != -1 and end != -1:
                ...
                symbol = crypto+'USDT'
                print('pair (symbol,crypto):',symbol,crypto)
                #print(type(symbol))
                #print(type(crypto))
            ...
            #Passage des ordres
            if symbol is not None and BorS is not None and PE is not None and close is not None and TP[1] is not None and SL is not None and levier is not None:
                ...
                #ordres          
                exchange.create_order(symbol=symbol, type='Limit', side=BorS, amount=quantity, price=PE)              #Order
                exchange.create_order(symbol=symbol, type='Limit', side=close, amount=quantity, price=TP[1])          #TP
                exchange.create_stop_limit_order(symbol=symbol,side=close, amount=quantity, price=SL, stopPrice=SL)   #SL
